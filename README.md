...
- get the script: `git clone git://github.com/pr1me/aui`

### Without git
- Increase cowspace partition: `mount -o remount,size=2G /run/archiso/cowspace`
- get the script: ` wget https://github.com/pr1me/aui/tarball/master -O - | tar xz`
    - an alternate URL (for less typing (github shorten)) is ` wget https://git.io/JfeQ7 -O - | tar xz`
    - an alternate URL (for less typing) is ` wget https://bit.ly/34yIbPy -O - | tar xz`
